 ...
 * и не явно: bv; Попробуйте объяснить почему оба варианта работают.
 */
...
public class Circle {
    ...
    //конструктор с заданным радиусом и цветом по умолчанию
    public Circle (double radius1){
        radius = radius1;
        color = "RED";
    }

    //конструктор с заданными радиусом и цветом
    ...
    //переопределяем стандартный метод toString()
